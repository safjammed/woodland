...
DROP TABLE IF EXISTS `wood_categories`;
...
INSERT INTO `wood_categories` (`cat_id`, `cat_pid`, `cat_name`, `cat_alias`, `cat_description`, `cat_img`, `no_topics`, `no_posts`, `cat_order`) VALUES
...
DROP TABLE IF EXISTS `wood_config`;
CREATE TABLE IF NOT EXISTS `wood_config` (
...
INSERT INTO `wood_config` (`id`, `option_name`, `option_value`) VALUES
(1, 'site_url', ''),
...
DROP TABLE IF EXISTS `wood_logs`;
...
DROP TABLE IF EXISTS `wood_plugins`;
CREATE TABLE IF NOT EXISTS `wood_plugins` (
...
INSERT INTO `wood_plugins` (`plg_name`, `plg_type`, `plg_status`, `plg_weight`, `plg_schema_ver`) VALUES
('post_notify','plugin', 1, 0, 1),
('sso','plugin', 0, 0, 1),
('uni_login','plugin', 0, 0, 1);

DROP TABLE IF EXISTS `wood_posts`;
CREATE TABLE IF NOT EXISTS `wood_posts` (
...
INSERT INTO `wood_posts` (`post_id`, `topic_id`, `cat_id`, `uid`, `imessage`, `omessage`, `post_created`, `post_modified`, `post_status`) VALUES
...
DROP TABLE IF EXISTS `wood_roles`;
CREATE TABLE IF NOT EXISTS `wood_roles` (
  `rid` int(11) NOT NULL,
...
INSERT INTO `wood_roles` (`rid`, `rname`) VALUES
(1, 'guest'),
(5, 'unverified user'),
(2, 'user'),
(3, 'moderator'),
...
DROP TABLE IF EXISTS `wood_role_permissions`;
CREATE TABLE IF NOT EXISTS `wood_role_permissions` (
...
INSERT INTO `wood_role_permissions` (`rid`, `permission`, `module`) VALUES
(1, 'view profile', 'core'),
(5, 'view profile', 'core'),
...
DROP TABLE IF EXISTS `wood_sessions`;
CREATE TABLE IF NOT EXISTS `wood_sessions` (
...
DROP TABLE IF EXISTS `wood_signups`;
CREATE TABLE IF NOT EXISTS `wood_signups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_smileys`;
CREATE TABLE IF NOT EXISTS `wood_smileys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `wood_smileys` (`id`, `symbol`, `image_name`) VALUES
(1, ':S', 'worried.gif'),
...
DROP TABLE IF EXISTS `wood_topics`;
CREATE TABLE IF NOT EXISTS `wood_topics` (
...
ALTER TABLE  `wood_topics` ADD INDEX (  `last_post_time` ) ;
ALTER TABLE  `wood_topics` ADD INDEX (  `cat_id` ,  `uid` ,  `topic_created` ) ;

INSERT INTO `wood_topics` (`topic_id`, `title`, `cat_id`, `post_id`, `uid`, `last_post_id`, `last_post_uid`, `last_post_name`, `topic_created`, `topic_updated`, `last_post_time`, `no_posts`, `no_views`, `topic_status`) VALUES
(1, 'Welcome to Codoforum', 3, 1, 1, 0, NULL, NULL, 1401549322, 0, 1401549322, 1, 0, 1);


DROP TABLE IF EXISTS `wood_users`;
CREATE TABLE IF NOT EXISTS `wood_users` (
  ...
  `rid` int(11) NOT NULL COMMENT 'role id of the user as described in wood_roles table',
  `oauth_id` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains user information' AUTO_INCREMENT=1 ;

ALTER TABLE  `wood_users` ADD UNIQUE (`mail`);

--
-- Table structure for table `wood_notify`
--

DROP TABLE IF EXISTS `wood_notify`;
CREATE TABLE IF NOT EXISTS `wood_notify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_notify_queue`;
CREATE TABLE IF NOT EXISTS `wood_notify_queue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_notify_subscribers`;
CREATE TABLE IF NOT EXISTS `wood_notify_subscribers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_notify_text`;
CREATE TABLE IF NOT EXISTS `wood_notify_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data` varchar(1024) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=138 ;

DROP TABLE IF EXISTS `wood_user_preferences`;
CREATE TABLE IF NOT EXISTS `wood_user_preferences` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `wood_user_preferences` (`uid`, `preference`, `value`) VALUES
...
DROP TABLE IF EXISTS `wood_views`;
CREATE TABLE IF NOT EXISTS `wood_views` (
  `date` date NOT NULL,
  `views` int(11) NOT NULL,
  PRIMARY KEY (`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `wood_mail_queue`;
CREATE TABLE IF NOT EXISTS `wood_mail_queue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_crons`;
CREATE TABLE IF NOT EXISTS `wood_crons` (
...
INSERT INTO `wood_crons` (`id`, `cron_name`, `cron_type`, `cron_interval`, `cron_started`, `cron_last_run`, `cron_status`) VALUES
(1, 'core', 'recurrence', 86400, 0, 0, 0);

CREATE TABLE IF NOT EXISTS `wood_bans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wood_blocks`;
CREATE TABLE IF NOT EXISTS `wood_blocks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `wood_blocks` (`id`, `module`, `theme`, `status`, `weight`, `region`, `content`, `visibility`, `pages`, `title`, `cache`) VALUES
(1, 'html', 'blue', 0, 0, 'block_main_menu', '<li><a href="#">Link</a></li>\r\n        <li class="dropdown">\r\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown <span class="caret"></span></a>\r\n          <ul class="dropdown-menu" role="menu">\r\n            <li><a href="#">Action</a></li>\r\n            <li><a href="#">Another action</a></li>\r\n            <li><a href="#">Something else here</a></li>\r\n            <li class="divider"></li>\r\n            <li><a href="#">Separated link</a></li>\r\n            <li class="divider"></li>\r\n            <li><a href="#">One more separated link</a></li>\r\n          </ul>\r\n</li>', 0, '', 'Main Menu', 1);

DROP TABLE IF EXISTS `wood_block_roles`;
CREATE TABLE IF NOT EXISTS `wood_block_roles` (
  `bid` int(11) NOT NULL COMMENT 'block id',
  `rid` int(11) NOT NULL,
  UNIQUE KEY `bid` (`bid`,`rid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `wood_unread_categories`;
CREATE TABLE IF NOT EXISTS `wood_unread_categories` (
...
DROP TABLE IF EXISTS `wood_unread_topics`;
CREATE TABLE IF NOT EXISTS `wood_unread_topics` (
...
DROP TABLE IF EXISTS `wood_tags`;
CREATE TABLE IF NOT EXISTS `wood_tags` (
...
DROP TABLE IF EXISTS `wood_tags_allowed`;
CREATE TABLE IF NOT EXISTS `wood_tags_allowed` (
  `tag_id` int(11) NOT NULL AUTO_INCREMENT,
