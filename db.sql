...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2017 at 02:50 AM
...
CREATE TABLE `cabins` (
  ...
  `cabin_desc` mediumtext NOT NULL,
...
INSERT INTO `cabins` (`id`, `cabin_name`, `cat_id`, `feature_image`, `cabin_desc`, `type`) VALUES
(4, 'test cabin - luxury - Scotland', 17, '150809478501234.png', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cabin_booking`
--

CREATE TABLE `cabin_booking` (
  `user_id` int(50) NOT NULL,
  `cabin_id` int(50) NOT NULL,
...
--
-- Table structure for table `cabin_gallery`
--

CREATE TABLE `cabin_gallery` (
  `id` int(50) NOT NULL,
  `cabin_id` int(50) NOT NULL,
...
--
-- Dumping data for table `cabin_gallery`
--

INSERT INTO `cabin_gallery` (`id`, `cabin_id`, `img`, `title`) VALUES
(7, 4, '1508094785krabi230.jpg', '1508094785krabi230.jpg'),
(8, 4, '1508094785krabi-copy.jpg', '1508094785krabi-copy.jpg');
...
(1, 'core', 'recurrence', 86400, 1508200145, 1508200145, 0),
(2, 'daily_digest', 'recurrence', 86400, 1508200145, 1508200145, 0),
(3, 'weekly_digest', 'recurrence', 604800, 1507949108, 1507949108, 0),
(4, 'mail_notify_send', 'recurrence', 1800, 1508200145, 1508200145, 0),
(5, 'forum_update', 'recurrence', 3600, 1508200145, 1508200145, 0);
...
(1, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Util.php\n            [line] => 29\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 844\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 657\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.username=:username\n                    [1] => Array\n                        (\n                            [username] => safayatjamil27@gmail.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 50\n            [function] => getByUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => safayatjamil27@gmail.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [12] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508199979),
(2, 0, 'Info', 'failed login attempt by safayatjamil27@gmail.comwrong username/password', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 76\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508199979),
(3, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Util.php\n            [line] => 29\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 844\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 657\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.username=:username\n                    [1] => Array\n                        (\n                            [username] => safayatjamil27@gmail.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 50\n            [function] => getByUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => safayatjamil27@gmail.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [12] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200045),
(4, 0, 'Info', 'failed login attempt by safayatjamil27@gmail.comwrong username/password', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 76\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200045),
(5, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Util.php\n            [line] => 29\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 844\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 657\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.username=:username\n                    [1] => Array\n                        (\n                            [username] => safayatjamil27@gmail.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 50\n            [function] => getByUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => safayatjamil27@gmail.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [12] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200050),
(6, 0, 'Info', 'failed login attempt by safayatjamil27@gmail.comwrong username/password', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 76\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200050),
(7, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Util.php\n            [line] => 29\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 844\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 657\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.username=:username\n                    [1] => Array\n                        (\n                            [username] => safayatjamil27@gmail.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 50\n            [function] => getByUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => safayatjamil27@gmail.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [12] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200052),
(8, 0, 'Info', 'failed login attempt by safayatjamil27@gmail.comwrong username/password', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 76\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => failed login attempt by safayatjamil27@gmail.comwrong username/password\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => safayatjamil27@gmail.com\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200052),
(9, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [mail] => safayatjamil27@gmail.com\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [mail] => safayatjamil27@gmail.com\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Util.php\n            [line] => 29\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [mail] => safayatjamil27@gmail.com\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 844\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [mail] => safayatjamil27@gmail.com\n    [username] => safayatjamil27@gmail.com\n)\n Array\n(\n    [59e179717d344view_inserted] => 1\n    [59e179717d347_csrf] => 85b67d00232b7046dae5ad576c8a784c\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 631\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.mail=:mail OR u.username=:username\n                    [1] => Array\n                        (\n                            [mail] => safayatjamil27@gmail.com\n                            [username] => safayatjamil27@gmail.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 89\n            [function] => getByMailOrUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => safayatjamil27@gmail.com\n                    [1] => safayatjamil27@gmail.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 87\n            [function] => req_pass\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200066);
INSERT INTO `codo_logs` (`id`, `uid`, `log_type`, `message`, `severity`, `trace`, `log_time`) VALUES
(10, 0, 'Info', 'failed login attempt by adminwrong username/password', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => failed login attempt by adminwrong username/password\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 76\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => failed login attempt by adminwrong username/password\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [username] => admin\n                    [password] => 01197110308a\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 77\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 429\n            [function] => call_user_func_array\n            [args] => Array\n                (\n                    [0] => Closure Object\n                        (\n                        )\n\n                    [1] => Array\n                        (\n                        )\n\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 104\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n            [line] => 989\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\woodland\\forum\\index.php\n            [line] => 22\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\woodland\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1508200138);
...
('bk5tonrtith0k28ahf2a4spag7', 1508201414, '59e179717d344view_inserted|b:1;59e179717d347_csrf|s:32:"85b67d00232b7046dae5ad576c8a784c";59e179717d344USER|a:1:{s:2:"id";i:1;}59e179717d344A_loggedin_created|s:16:"October 14, 2017";59e179717d344A_loggedin_avatar|s:84:"http://localhost/woodland/forum/sites/default/assets/img/profiles/icons/A_ee00ff.png";59e179717d344A_loggedin_username|s:5:"admin";59e179717d344A_loggedin|s:5:"admin";codo_zombie_crons_cleanup|b:1;');
...
(1, 'admin', 'admin', '$2a$08$lyMgFmevGGBdcXge2/B1heWK4ZyDIZso/OvqxeS4q2lQRbF3h8c46', NULL, '1000963@daffodil.ac', 1507948935, 1508200165, 0, 1, 'A_ee00ff.png', NULL, 1, 0, '0', 0, 0),
...
INSERT INTO `places` (`id`, `cat_name`, `cat_desc`, `cat_slug`) VALUES
(17, 'Scotland', '<p>Beautiful Woodlands of Scoland</p>', 'scotland'),
(18, 'Britain', '<p>Woodland cabins at britain</p>', 'britain'),
(19, 'Place 3', '<p>Place 3 details</p>', 'place3'),
(20, 'place 4', '<p>Place 4</p>', 'place 4');
...
INSERT INTO `prices` (`id`, `cabin_id`, `date_start`, `date_end`, `price`, `regular`) VALUES
(4, 4, '2017-10-15', '2017-10-20', 23.5, 1),
(5, 4, '2017-10-14', '2017-10-21', 20.22, 0);
...
INSERT INTO `users` (`id`, `password`, `fname`, `lname`, `email`, `role`, `verified`, `join_date`, `address`, `phone_number`, `username`, `gender`) VALUES
(1, '$2y$10$X/DGKnmENyBWXDskkyEDcOFOODL7XsUbSOisu.rkH/rdkP3hf1u6i', 'Safayat', 'Jamil', 'safayatjamil27@gmail.com', 0, 1, '2017-08-28 17:56:29', 'Dhaka', '1969741278', 'safjammed', 'male'),
(2, '$2y$10$gJ.GIAPmQEeud6VaExvPauBhjrN/ThekceNmDMQpewesR/lMwO8Ly', 'site', 'Admin', 'admin@site.com', 0, 1, '2017-10-16 23:42:18', 'Not Available', NULL, 'admin', 'male');
...
--
-- Indexes for table `cabin_gallery`
--
ALTER TABLE `cabin_gallery`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cabin_gallery`
--
ALTER TABLE `cabin_gallery`
